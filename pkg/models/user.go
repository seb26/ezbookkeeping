...
type User struct {
	...
	FiscalYearStartDate  core.FiscalYearStartDate `xorm:"TINYINT"`
...
type UserBasicInfo struct {
	...
	FiscalYearStartDate  core.FiscalYearStartDate `json:"FiscalYearFormat"`
...
type UserProfileUpdateRequest struct {
	...
	FiscalYearStartDate  *core.FiscalYearStartDate `json:"FiscalYearStartDate" binding:"omitempty,min=0,max=200"`
...
func (u *User) ToUserBasicInfo(avatarProvider core.UserAvatarProviderType, avatarUrl string) *UserBasicInfo {
	return &UserBasicInfo{
		...
		FiscalYearStartDate:  u.FiscalYearStartDate,
