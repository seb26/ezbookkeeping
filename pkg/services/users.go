...
func (s *UserService) UpdateUser(c core.Context, user *models.User, modifyUserLanguage bool) (keyProfileUpdated bool, emailSetToUnverified bool, err error) {
	...
	if core.FISCAL_YEAR_START_DATE_TYPE_DEFAULT <= user.FiscalYearStartDate && user.FiscalYearStartDate < core.FISCAL_YEAR_START_DATE_TYPE_INVALID {
		updateCols = append(updateCols, "fiscal_year_start_date")
	}
